...
export interface ApiBoxBox extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resource: Schema.Attribute.Media<
...
export interface ApiDemandDemand extends Struct.CollectionTypeSchema {
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatappim: Schema.Attribute.String;
  };
}
...
export interface ApiOrderWorkflowOrderWorkflow
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    delivery_channel: Schema.Attribute.String;
    delivery_contact: Schema.Attribute.String;
    delivery_location: Schema.Attribute.String;
    delivery_notification: Schema.Attribute.String;
    details: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-workflow.order-workflow'
    > &
      Schema.Attribute.Private;
    orderdt: Schema.Attribute.Date;
    orderstatus: Schema.Attribute.String;
    ordervalue: Schema.Attribute.String;
    product_list: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<
      ...
      true
    >;
    imageavatar: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    manufacturedt: Schema.Attribute.Date;
...
export interface ApiShippingWorkflowShippingWorkflow
  extends Struct.CollectionTypeSchema {
  collectionName: 'shipping_workflows';
  info: {
    displayName: 'shipping-workflow';
    pluralName: 'shipping-workflows';
    singularName: 'shipping-workflow';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    drivername: Schema.Attribute.String;
    driverphone: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shipping-workflow.shipping-workflow'
    > &
      Schema.Attribute.Private;
    product: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    remarks: Schema.Attribute.RichText;
    shippingdt: Schema.Attribute.DateTime;
    source: Schema.Attribute.String;
    status_data: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vehicledetails: Schema.Attribute.String;
  };
}
...
export interface ApiSupplierSupplier extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vehicledetails: Schema.Attribute.Text;
  };
}
...
export interface ApiWarehouseWarehouse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    managerphone: Schema.Attribute.String;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    startdt: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    warehouseid: Schema.Attribute.String & Schema.Attribute.Unique;
  };
}
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useravatar: Schema.Attribute.String;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-workflow.order-workflow': ApiOrderWorkflowOrderWorkflow;
      'api::product.product': ApiProductProduct;
      'api::shipping-workflow.shipping-workflow': ApiShippingWorkflowShippingWorkflow;
